...
# Azure Web App Deployment Script for Crypto Trading Bot

echo "🚀 Deploying Crypto Trading Bot to Azure Web App..."
...
# Configuration
RESOURCE_GROUP="crypto-trading-bot-rg"
APP_NAME="crypto-trading-bot-$(date +%s)"
LOCATION="East US"
PLAN_NAME="crypto-trading-plan"
